...
const reviews = [
  {
    ...
    username: "Student @pccoer",
    body: "Very nice workshop, really help me alot in personal growth, in both technical and soft skill development. all the senior who taught us are really nice, kind and helping. Had a great session overall. Request: please conduct a session on ethical hacking and cyber security please.",
  ...
  },
  {
    name: "Madhura Dhake",
    username: "Student @pccoer",
    body: "Workshop was very exciting.Got to learn many new things.The seniors who taught us were very helpful,kind and nice.It was a great experience.Would love to attend more such sessions.",
