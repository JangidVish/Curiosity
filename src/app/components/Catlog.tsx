...
function Catlog() {
  ...
  return (
    <div className='w-full dark:bg-black dark:bg-grid-white/[0.15] relative flex flex-col items-center justify-center sm:overflow-hidden bg-black border-b-4 p-4 overflow-x-hidden' id='catlog'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 justify-around align-middle ml-10 ">
    ...
    <div className="info"><p className='mt-4 text-green-500 text-sm text-left'>*Some images are for representation purpose, actual product may vary</p></div>
    </div>
  )
}
